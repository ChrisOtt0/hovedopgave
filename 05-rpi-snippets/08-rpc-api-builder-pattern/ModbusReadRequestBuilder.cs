...
public class ModbusReadRequestBuilder : IModbusRequestBuilder
{
    public void Reset()
    {
        _request = null;
    ...
    {
        if (_command is null) throw new Exception("ModbusCommand type not set!");
        if (_updateDelegate is null) throw new Exception("UpdateDelegate not set!");
        _request = new ModbusReadRequest(owner, _command, _updateDelegate);
    }
    ...
    public ModbusReadRequestBuilder() {}
}